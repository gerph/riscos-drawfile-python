...
package:
	...
	printf '%s\n' \
		...
		'Description: Structural decoder and SVG converter for RISC OS DrawFiles' \
		' Decode RISC OS DrawFile documents into a structural object model,' \
		' and convert them to SVG.' \
