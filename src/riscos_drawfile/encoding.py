...
Text within a DrawFile (font table names, and single-line DrawText
objects) uses this alphabet, not plain ISO-8859-1/Latin-1 (bytes
...
derived from any particular application's own conversion source
(which, being RISC OS software itself, never needed to translate out
of its own native alphabet).
"""
